...
### Path A — Subagent support available (Claude Code)

Launch 3 `plan-researcher` agents in parallel using the Task tool. Assign each a distinct focus:
...
### Path B — No subagent support (Codex CLI, Cursor, Windsurf, Aider, etc.)
