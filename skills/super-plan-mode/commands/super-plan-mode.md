...
|---|-----------|-------|--------|------|------|
| 1 | 2026-04-09 14:32 | Add OAuth login | M | Medium | `.agents/plans/super-plan-mode-1744209120.md` |
...
Follow the format in `references/plan-template.md` exactly. Every section is required unless marked N/A with a reason.
...
```
Default: `.agents/plans/super-plan-mode-[unix-timestamp].md`
